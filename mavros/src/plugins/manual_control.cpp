...
private:
    ...
    plugin::filter::SystemAndOk filter [[maybe_unused]])
  {
    ...
    // manual_control_msg.aux1 = (manual_control.aux1 / 1000.0);  // MANUAL_CONTROL.aux1 absent in this mavlink
    // manual_control_msg.aux2 = (manual_control.aux2 / 1000.0);  // MANUAL_CONTROL.aux2 absent in this mavlink
    // manual_control_msg.aux3 = (manual_control.aux3 / 1000.0);  // MANUAL_CONTROL.aux3 absent in this mavlink
    // manual_control_msg.aux4 = (manual_control.aux4 / 1000.0);  // MANUAL_CONTROL.aux4 absent in this mavlink
    // manual_control_msg.aux5 = (manual_control.aux5 / 1000.0);  // MANUAL_CONTROL.aux5 absent in this mavlink
    // manual_control_msg.aux6 = (manual_control.aux6 / 1000.0);  // MANUAL_CONTROL.aux6 absent in this mavlink
  ...
  void send_cb(const mavros_msgs::msg::ManualControl::ConstSharedPtr req)
  {
    ...
    msg.s = req->s;
    msg.t = req->t;
    // msg.aux1 = req->aux1;  // MANUAL_CONTROL.aux1 absent in this mavlink
    // msg.aux2 = req->aux2;  // MANUAL_CONTROL.aux2 absent in this mavlink
    // msg.aux3 = req->aux3;  // MANUAL_CONTROL.aux3 absent in this mavlink
    // msg.aux4 = req->aux4;  // MANUAL_CONTROL.aux4 absent in this mavlink
    // msg.aux5 = req->aux5;  // MANUAL_CONTROL.aux5 absent in this mavlink
    // msg.aux6 = req->aux6;  // MANUAL_CONTROL.aux6 absent in this mavlink
